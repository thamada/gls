...
Device 0: "NVIDIA GeForce RTX 5090"
  CUDA Driver Version / Runtime Version          12.8 / 11.8
  CUDA Capability Major/Minor version number:    12.0
  Total amount of global memory:                 32120 MBytes (33680457728 bytes)
...
deviceQuery, CUDA Driver = CUDART, CUDA Driver Version = 12.8, CUDA Runtime Version = 11.8, NumDevs = 1
Result = PASS
'''
